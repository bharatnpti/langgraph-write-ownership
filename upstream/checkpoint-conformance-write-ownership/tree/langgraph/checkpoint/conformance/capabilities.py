...
_CAPABILITY_METHOD_MAP: dict[Capability, str] = {
    ...
    # Absent from BaseCheckpointSaver entirely -- which is why adding this
    # capability needs no base-class change. `_is_overridden` below returns True
    # for a method the base class does not define, so a saver is detected purely
    # by defining it. See ownership.py.
